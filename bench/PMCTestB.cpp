...
const char * TempOutTitle = "Extra out";
...
#include "test-userdata.h"

#ifdef INTERVAL_NAME
const char *iv_name = INTERVAL_NAME;
#else
const char *iv_name = NULL;
#endif

#ifdef INTERVAL_VALUE
int iv_val = INTERVAL_VALUE;
#else
int iv_val = 0;
#endif

#ifdef LOOP_COUNT
int div_result = LOOP_COUNT;
#else
int div_result = 1;
#endif
